...
export const alumni: Alumni[] = [
  // Founder
  { name: 'Sundeep Chanana', company: 'Horatio Partners', position: 'CEO & Founder', class: 'Founder' },
  { name: 'Manpreet (Sonu) Gill', company: 'Lockton', position: 'Executive Vice President', class: 'Founder' },
  { name: 'Mohit Jain', company: 'Immigranted', position: 'Co-Founder', class: 'Founder' },
  { name: 'Himanshu Shah', company: 'Strategic Growth Partners', position: 'COO', class: 'Founder' },
  ...
  { name: 'Rakesh Vij', company: 'Aricent', position: 'Chief Business Officer', class: 'Alpha' },

  // Beta
  { name: 'Manav Agarwal', company: 'Vreal', position: 'Founder', class: 'Beta' },
  { name: 'Arjun Arora', company: 'Format One', position: 'Managing Partner', class: 'Beta' },
  { name: 'Neil Bhalerao', company: 'Sutter Health', position: 'Impatient Physicial Advisor', class: 'Beta' },
  { name: 'Atul Bhatia', company: 'Stripe', position: 'Software Engineer', class: 'Beta' },
  { name: 'Vikram Kumar', company: 'Lexo Technologies', position: 'CEO & Founder', class: 'Beta' },
  { name: 'Vikram Patel', company: 'Los Palos Gastroenterelogy Specialists', position: 'Physician', class: 'Beta' },

  // Gamma
  { name: 'Nikhil Arora', company: 'Back to the Roots', position: 'Co-CEO & Co-Founder', class: 'Gamma' },
  { name: 'Varoon Bhagat', company: 'Splunk', position: 'VP, Head of Corporate Development', class: 'Gamma' },
  { name: 'Arjun Chemparathy', company: 'OneSignal', position: 'Full Stack Engineer', class: 'Gamma' },
  { name: 'Tushar Kumar', company: 'Twin Peaks Wealth Advisors', position: 'Private Wealth Advisor', class: 'Gamma' },
  { name: 'Jigar Patel', company: 'Monterey County Public Defender', position: 'Attorney', class: 'Gamma' },
  { name: 'Salman Rahman', company: 'University of California, San Francisco', position: 'Cardiac Hospitalist Program Director', class: 'Gamma' },
  { name: 'Prabhu Ramaswamy', company: 'Tekpundits', position: 'CFO', class: 'Gamma' },

  // Delta
  { name: 'Rakesh Chanana', company: 'Emergency Care Partners', position: 'Chief Development Officer', class: 'Delta' },
  { name: 'Jehan Damji', company: 'Roblox', position: 'Director of Product, Marketplace', class: 'Delta' },
  { name: 'Rohan Desai', company: 'Responsive', position: 'Co-Founder', class: 'Delta' },
  { name: 'Abhishek Doshi', company: 'Meta', position: 'Director of Engineering', class: 'Delta' },
  { name: 'Sanpreet Gill', company: 'Catalina Structured Funding, Inc.', position: 'General Counsel', class: 'Delta' },
  { name: 'Nadim Laiwala', company: 'Moelis & Company', position: 'Managing Director', class: 'Delta' },
  { name: 'Arshdeep Mand', company: 'WorkRamp', position: 'CTO & Co-Founder', class: 'Delta' },
  { name: 'Praveen Pendyala', company: 'Cleveland Clinic Akron General', position: 'Staff Radiation Oncology', class: 'Delta' },
  ...
  { name: 'Anuj Verma', company: 'Airbnb', position: 'Product Lead', class: 'Zeta' },
  { name: 'Rohan Verma', company: 'Arbor Advisory', position: 'Founder & Principal', class: 'Zeta' },

  // Eta
  { name: 'Tarun Bhatnagar', company: 'Surveyor Capital', position: 'Analyst', class: 'Eta' },
  { name: 'Sumer Joshi', company: 'Accelerate Change Network', position: 'Digital Strategy Vice President', class: 'Eta' },
  { name: 'Darshan Kasar', company: 'Apple', position: 'Product Design Manager', class: 'Eta' },
  { name: 'Sahil Kotak', company: 'Accelerate Change Network', position: 'Vice President, Digital Strategy', class: 'Eta' },
  { name: 'Prateek Madhapurmath', company: 'Amazon', position: 'Software Development Engineer 2', class: 'Eta' },
  ...
  { name: 'Chetan Ambastha', company: 'Stanford University', position: 'Resident Physician', class: 'Lambda' },
  { name: 'Kiran Arimilli', company: 'Doppel', position: 'Staff Software Engineer', class: 'Lambda' },
  { name: 'Karan Das', company: 'NeuraFlash', position: 'Managing Salesforce Solution Architect', class: 'Lambda' },
  { name: 'Jesal Gandhi', company: 'First Turn Management', position: 'Senior Research Analyst', class: 'Lambda' },
  { name: 'Kapil Kashyap', company: 'Oklahoma City Thunder', position: 'Senior Data Solutions Software Engineer', class: 'Lambda' },
  { name: 'Atul Lanka', company: 'JPMorgan Chase & Co.', position: 'Vice President, Data Science Lead', class: 'Lambda' },
  { name: 'Pauldeep Singh Mann', company: 'Clari', position: 'Data Analyst', class: 'Lambda' },
  { name: 'Umang Methi', company: 'DriveWealth', position: 'Senior Software Engineer', class: 'Lambda' },
  { name: 'Michael Murran', company: 'HYBE America', position: 'Finance Manager', class: 'Lambda' },
  { name: 'Aditya Pradhan', company: 'Herald', position: 'Integrations Lead', class: 'Lambda' },
  ...
  { name: 'Rishabh Wason', company: 'Salesforce', position: 'Lead Software Engineer', class: 'Nu' },

  // Xi
  { name: 'Yash Agarwal', company: 'Juniper Networks', position: 'NPI Manufacturing Engineer Manager', class: 'Xi' },
  { name: 'Pratik Bhat', company: 'Drata', position: 'AI Product Lead', class: 'Xi' },
  { name: 'Srikar Chikkala', company: 'Balyasny Asset Management', position: 'Senior Associate', class: 'Xi' },
  { name: 'Diwanshu Kumar', company: 'University of Arizona College of Medicine', position: 'Internal Medical Resident', class: 'Xi' },
  ...
  { name: 'Aman Thakur', company: 'Globus Medical', position: 'Software Engineer', class: 'Omicron' },

  // Pi
  { name: 'Anish Deshpande', company: 'SAP', position: 'Software Engineer', class: 'Pi' },
  { name: 'Tejas Dhindsa', company: 'The Moynihan Center at CCNY', position: 'Communications Consultant', class: 'Pi' },
  { name: 'Ishan Gurnani', company: 'BNP Paribas', position: 'FX Strategist', class: 'Pi' },
  { name: 'Shivansh Kumar', company: 'LinkedIn', position: 'Senior Software Engineer', class: 'Pi' },
  { name: 'Vidur Maheshwari', company: 'Google', position: 'Software Engineer', class: 'Pi' },
  { name: 'Rajan Parikh', company: 'Creighton University School of Medicine', position: 'Medical Student', class: 'Pi' },
  { name: 'Parth Patel', company: 'Dunkin\' Donuts', position: 'Franchise Owner', class: 'Pi' },
  { name: 'Param Shah', company: 'Microsoft', position: 'Product Manager 2', class: 'Pi' },
  { name: 'Shahrukh Shaikh', company: 'CLEAR', position: 'Strategic Finance Senior Associate', class: 'Pi' },
  ...
  { name: 'Lucas Narine', company: 'Fiserv', position: 'Software Engineer', class: 'Sigma' },
  ...
  { name: 'Chiraphat Techasiri', company: 'Lumen Technologies', position: 'Software Engineer', class: 'Phi' },
...
export const alumniByClass = alumni.reduce((acc, alumnus) => {
...
// Get unique companies for statistics
export const uniqueCompanies = Array.from(new Set(alumni.map(a => a.company)));

// Notable companies for highlighting
export const notableCompanies = [
  'Google', 'Microsoft', 'Amazon', 'Meta', 'Apple', 'Stripe', 'Coinbase', 
  'Salesforce', 'Airbnb', 'LinkedIn', 'Tesla', 'Spotify', 'Netflix'
];